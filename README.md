...
(프리코스1주차 미션과 다르게 진짜 계산기임으로 문자열에 관련된 기능이 아니라 계산기 로직을 구현해야 한다.)
...
4. 나눗셈 기능 구현
5. 곱하기 기능 구현
6. 한자리 숫자가 아니라 여러자리 숫자를 입력받는 기능 리팩토링
7. 동시에 여러가지 연산자 처리

## 💡 오픈미션 기능 구현 중 발생한 리팩토링 및 고려 사항

1. 자바에서 했던 문자열과 다르게 입력값을 계속해서 받을수도 있고 안받을수도 있다.
2. 한번의 연산자가 아닌 여러번의 연산자가 있을경우 먼저 선언된 연산자를 진행할까? 한번에 진행할까?
3.
